...
pt3 p(int x, int y, int z) {
    return { (ftype)x, (ftype)y, (ftype)z };
}
...
int main() {
    ...
    points.push_back(p(1, 0, 0));
    points.push_back(p(0, 1, 0));
    points.push_back(p(0, 0, 1));
    points.push_back(p(1, 1, 0));
    points.push_back(p(1, 0, 1));
    points.push_back(p(0, 1, 1));
    points.push_back(p(1, 1, 1));

    vector<face> res = hull3(points);
    for (auto i : res) cout << s(points[i.a]) << " " << s(points[i.b]) << " " << s(points[i.c]) << endl;
